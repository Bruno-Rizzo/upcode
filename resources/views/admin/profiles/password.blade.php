                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('profiles.password.update') }}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="password" placeholder="Senha Atual" name="oldPassword" @error('oldPassword') style="border:1px solid red" @enderror>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="password" placeholder="Nova Senha" name="password" @error('password') style="border:1px solid red" @enderror>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="password" placeholder="Confirma Senha" name="confirmPassword" @error('oldPassword') style="border:1px solid red" @enderror>
