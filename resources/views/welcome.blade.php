...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html">UPCODE</a></h1>
                    ...
                    @if (Route::has('login'))
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <li><a class="nav-link scrollto" href="{{ route('register') }}"">Registre-se</a></li>
                            @endif
                        @endauth
                    @endif
                </ul>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
            <h1>BEM VINDO À UPCODE</h1>
            <h2>Site de estudo do sistema Laravel</h2>
            <a href="#about" class="btn-get-started scrollto">CONHEÇA A EMPRESA</a>
        </div>
    </section><!-- End Hero -->
